...
function init()
    neutral_station = SpaceStation():setTemplate("Large Station"):setPosition(0, -15000):setRotation(random(0, 360)):setFaction(Independent_Faction)
	...
	friendly_station = SpaceStation():setTemplate("Large Station"):setPosition(-10000, -25000):setRotation(random(0, 360)):setFaction(Player_Faction)
    ...
    for n=1,5 do
        setCirclePos(CpuShip():setTemplate("Flavia"):setFaction(Independent_Faction):setScanned(true), 0, -15000, random(0, 360), random(1000, 5000))
    end
	...
	for n=1,20*battle_scale do
		CpuShip():setTemplate("MT52 Hornet"):setPosition(random(-10000 * location_scale, 10000 * location_scale), random(0, 3000)):setRotation(90):setFaction(Player_Faction):orderRoaming():setScanned(true)
	end
	for n=1,10*battle_scale do
		CpuShip():setTemplate("Phobos T3"):setPosition(random(-10000 * location_scale, 10000 * location_scale), random(0, 2000)):setRotation(90):setFaction(Player_Faction):orderRoaming():setScanned(true)
	end
