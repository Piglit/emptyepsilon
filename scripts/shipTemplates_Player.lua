...
--[[Missile Corvette--]]
--TODO test if torpedo config on this model is good
template = ShipTemplate():setName("Crucible"):setLocaleName(_("Crucible")):setClass(_("Corvette"),_("Popper")):setModel("AtlasHeavyDreadnought"..color_player):setType("playership")
