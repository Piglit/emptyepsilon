...
function turkeyNemesis(delta)
	...
	if turkeyNemesisTimer < 0 then
		...
		enemyCrutch = CpuShip():setFaction("Ghosts"):setCallSign("Crutch"):setTemplate("Orca F12"):orderAttack(friendTurkeySurprise):setPosition(tx+vx,ty+vy)
		...
		if difficulty >= 1 then
			tgAngle = random(0,360)
			vx, vy = vectorFromAngle(tgAngle,random(4000,5000))
			enemyMalnutrition = CpuShip():setFaction("Ghosts"):setCallSign("Malnutrition"):setTemplate("Orca F12"):orderAttack(friendTurkeySurprise):setPosition(tx+vx,ty+vy)
		...
		if difficulty > 1 then
			tgAngle = random(0,360)
			vx, vy = vectorFromAngle(tgAngle,random(4000,5000))
			enemyPlague = CpuShip():setFaction("Ghosts"):setCallSign("Plague"):setTemplate("Orca F12.M"):orderAttack(friendTurkeySurprise):setPosition(tx+vx,ty+vy)
